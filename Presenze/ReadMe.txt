========================================================================
    LIBRERIA STATICA: cenni preliminari sul progetto Presenze
========================================================================

La creazione guidata applicazione ha creato questo progetto di libreria Presenze.

Questo file contiene un riepilogo del contenuto di ciascun file che fa parte
dell'applicazione Presenze.
...
StdAfx.h, StdAfx.cpp
    Tali file vengono utilizzati per generare il file di intestazione precompilato Presenze.pch e il file dei tipi precompilato StdAfx.obj.
